...
export default function ContactForm() {
	...
	return (
		...
		<form ref={formRef} className="space-y-8" onSubmit={methods.handleSubmit(onSubmit)}>
			<CompleteInput
				type={"email"}
				id={"email"}
			...
			<HeadingButton text={"Send message"} type={"submit"} disabled={methods.formState.isSubmitting} />
		</form>
		</FormProvider>
	);
}

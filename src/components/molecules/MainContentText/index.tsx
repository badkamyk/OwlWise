...
export default function MainContentText({ headingText, paragraphText, headingClassName, paragraphClassName, secondaryText }: MainContentTextType) {
    return (
        <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <MainContentParagraph text={secondaryText} className={paragraphClassName} />
        </div>
    )
}

...
export default function ProcessSection() {
	...
	return (
		<div
			className="flex h-fit flex-col justify-center gap-8 bg-gradient-to-b from-gray-600 via-rose-100 to-teal-100 px-3 py-9 text-center md:px-0"
			data-testid="process-section"
		>
			<HeadingMain secondPhrase={"Our process"} />
